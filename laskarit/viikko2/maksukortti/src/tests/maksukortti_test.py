...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_edullisen_lounaan_voi_ostaa_jos_rahaa_juuri_sen_verran(self):
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
        self.kortti.syo_edullisesti()
    ...
    def test_maukkaan_lounaan_voi_ostaa_jos_rahaa_juuri_sen_verran(self):
        self.kortti.lataa_rahaa(2)
        self.kortti.syo_maukkaasti()
        self.kortti.syo_maukkaasti()
        # nyt kortin saldo on 4.0 euroa
        self.kortti.syo_maukkaasti()
